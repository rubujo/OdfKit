...
|---|---|---|---|---|
| `ODS-PACKAGE-001` | ODS | PackageFidelity | round-trip-verified | Een package-roundtrip impliceert geen formuleherberekening of volledige spreadsheetsemantiek. |
| `ODS-SEMANTIC-001` | ODS | SemanticApiDepth | semantic-contract-verified | Leest opgeslagen waarden en formules, maar berekent niet opnieuw. |
| `ODT-SEMANTIC-001` | ODT | SemanticApiDepth | semantic-contract-verified | Geen pagina-indelings- of renderingengine. |
| `ODP-SEMANTIC-001` | ODP | SemanticApiDepth | semantic-contract-verified | DOM/package-workload; geen streaming dia-API. |
| `ODG-SEMANTIC-001` | ODG | SemanticApiDepth | semantic-contract-verified | Geen SmartArt-indeling of pixelrendering. |
| `ODF-INTEROP-001` | ODF | InteropEvidence | interop-tested | Eén geteste LibreOffice-versie garandeert geen pixelgelijkheid in elke suite. |
...
Semantic coverage schema v4 vereist bovendien voor elk onderwerp bewijs voor `Create`, `Get`,
