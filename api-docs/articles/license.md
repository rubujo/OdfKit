...
> 方式影響任何人的專利權或商標權。採用者仍應自行評估實作與使用情境涉及的第三方專利風險。

第三方相依套件、結構描述、工具與測試資料維持各自授權，不因 OdfKit 採 CC0 而成為公有領域；
再散布前請閱讀 [THIRD-PARTY-NOTICES](https://github.com/rubujo/OdfKit/blob/main/THIRD-PARTY-NOTICES.md)。
