...
| [Microsoft.Win32.Registry](https://github.com/dotnet/runtime) | Compatibilidad con netstandard2.0 para resolver orígenes del Registro de Windows EUDC | [MIT](https://github.com/dotnet/runtime/blob/main/LICENSE.TXT) |
