...
Sono ammessi standard pubblici OASIS/ISO/RFC/W3C, formati pubblici, fixture ridistribuibili e test
indipendenti. È vietato copiare LibreOffice C++, Java ODF Toolkit, Apache POI, NPOI, SDK commerciali o
binari chiusi decompilati. JSON Collaboration è compatibile, non un porting del sorgente.

## 4. Standard e marchi

Sono ammessi riferimenti descrittivi; non si può suggerire certificazione o approvazione di OASIS, TDF,
LibreOffice o Apache.

## 5. Developer Certificate of Origin (DCO)

I contributori devono attestare origine o diritto di invio, assenza di codice non ridistribuibile,
...
## 7. Segnalazioni di sicurezza

Non esistono oggi tracker pubblico, canale privato o garanzia di trattamento. Non pubblicare dettagli
completi di exploit e separare sicurezza da licenze o violazioni.

## 8. Documenti correlati

Vedere l’[indice clean-room](https://github.com/rubujo/OdfKit/blob/main/docs/provenance/clean-room-source-index.md),
la [politica delle estensioni](https://github.com/rubujo/OdfKit/blob/main/docs/foreign-extension-policy.md) e
le [regole del corpus](https://github.com/rubujo/OdfKit/blob/main/docs/corpus-manifest.md).
