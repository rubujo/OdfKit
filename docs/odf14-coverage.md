...
| 外部 ODF Validator baseline | ODF Toolkit / ODF Validator valid-invalid classification | `OdfExternalValidator`、CLI `validate --baseline` | `CliTests`、`docs/odf-toolkit-parity.md` | partial | baseline 為可選外部工具；尚需加入官方與真實 corpus 對照結果。 |
...
- 建立 ODF Toolkit / ODF Validator parity matrix 與 documented exceptions。
