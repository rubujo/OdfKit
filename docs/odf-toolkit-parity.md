...
| Typed DOM | generated DOM wrappers、`OdfNodeFactory`、`OdfTypedDomCoverage`、typed attribute helpers | ODFDOM | partial | 以 [typed-dom-coverage.md](typed-dom-coverage.md)、CLI `typed-dom-coverage` 與 CI artifact 追蹤 wrapper / factory / attribute coverage；generated wrappers 已包含 integer、decimal、date/dateTime、time、duration、length/percent、style family、ODF version 與 media type typed property，仍需擴大 datatype 類別並補齊 ODFDOM sample parity。 |
