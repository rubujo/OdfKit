...
| `OdfKit.WebFonts.OpenType` | 字型引擎 | `net10.0;netstandard2.0` | 純 .NET TrueType 子集化、TTF／WOFF、net10 WOFF2 與 experimental TrueType variable | CFF／CFF2、PostScript variable、color font 明確拒絕；可用格式見 managed 架構契約 |
