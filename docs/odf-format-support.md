...
| `.oth` | `application/vnd.oasis.opendocument.text-web` | `TextWeb` | complete | complete | complete | complete | validated | complete | usable-variant | `ComplianceTests`, `PackageRoundTripTests` |
...
| `.otc` | `application/vnd.oasis.opendocument.chart-template` | `ChartTemplate` | complete | complete | complete | complete | validated | complete | usable-variant | `ComplianceTests`, `PackageRoundTripTests` |
...
| `.otf` | `application/vnd.oasis.opendocument.formula-template` | `FormulaTemplate` | complete | complete | complete | complete | validated | complete | usable-variant | `ComplianceTests`, `PackageRoundTripTests` |
...
| `.oti` | `application/vnd.oasis.opendocument.image-template` | `ImageTemplate` | complete | complete | complete | complete | validated | complete | usable-variant | `ComplianceTests`, `PackageRoundTripTests` |
...
| `.fodc` | `application/vnd.oasis.opendocument.chart` | `FlatChart` | complete | complete | complete | complete | validated | complete | usable-variant | `PackageRoundTripTests`, `CorpusComplianceTests` |
| `.fdf` | `application/vnd.oasis.opendocument.formula` | `FlatFormula` | complete | complete | complete | complete | validated | complete | usable-variant | `PackageRoundTripTests`, corpus manifest |
| `.fodi` | `application/vnd.oasis.opendocument.image` | `FlatImage` | complete | complete | complete | complete | validated | complete | usable-variant | `PackageRoundTripTests`, `CorpusComplianceTests` |
