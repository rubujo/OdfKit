...
| Medium Group 強制函式名稱 | 194／272 | 已有參照聯集／交集、命名運算式、矩陣、機率分佈與常用統計函式；尚缺 78 個累計強制函式。 |
| Large Group 強制函式名稱 | 283／388 | 已有 inline array、矩陣、複數、進位轉換與額外統計／財務函式；尚缺 105 個累計強制函式，以及完整陣列公式、自動交集、外部名稱與區域名稱求值。 |
