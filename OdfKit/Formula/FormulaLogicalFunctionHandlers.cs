...
/// <summary>
/// 邏輯與位元運算內建公式函式處理常式（內部協作者）。
/// </summary>
internal static class FormulaLogicalFunctionHandlers
{
    internal static object EvaluateIf(List<AstNode> arguments, IEvaluationContext context)
    {
    ...
    internal static object EvaluateAnd(List<AstNode> arguments, IEvaluationContext context)
    {
    ...
    internal static object EvaluateOr(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count == 0)
            return OdfFormulaError.Value;
    ...
    internal static object EvaluateXor(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count == 0)
            return OdfFormulaError.Value;
        bool hasLogical = false;
    ...
    internal static object EvaluateIfError(List<AstNode> arguments, IEvaluationContext context)
    {
    ...
    internal static object EvaluateIfNa(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 2)
            return OdfFormulaError.Value;
        var first = arguments[0].Evaluate(context);
    ...
    internal static object EvaluateIfs(List<AstNode> arguments, IEvaluationContext context)
    {
    ...
    internal static object EvaluateSwitch(List<AstNode> arguments, IEvaluationContext context)
    {
    ...
    internal static object EvaluateIsBlank(List<AstNode> arguments, IEvaluationContext context)
    {
    ...
    internal static object EvaluateIsNa(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 1)
            return OdfFormulaError.Value;
    ...
    internal static bool IsReferenceNode(AstNode node)
    {
    ...
    internal static object EvaluateIsRef(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 1)
            return OdfFormulaError.Value;
    ...
    internal static object EvaluateType(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 1)
            return OdfFormulaError.Value;
    ...
    internal static object EvaluateIsOdd(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 1)
            return OdfFormulaError.Value;
    ...
    internal static object EvaluateIsEven(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 1)
            return OdfFormulaError.Value;
        var val = arguments[0].Evaluate(context);
    ...
    internal static object EvaluateBitAnd(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 2)
            return OdfFormulaError.Value;
    ...
    internal static object EvaluateBitOr(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 2)
            return OdfFormulaError.Value;
        var v1 = arguments[0].Evaluate(context);
    ...
    internal static object EvaluateBitXor(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 2)
            return OdfFormulaError.Value;
        var v1 = arguments[0].Evaluate(context);
    ...
    internal static object EvaluateBitLShift(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 2)
            return OdfFormulaError.Value;
        var v1 = arguments[0].Evaluate(context);
    ...
    internal static object EvaluateBitRShift(List<AstNode> arguments, IEvaluationContext context)
    {
        if (arguments.Count != 2)
            return OdfFormulaError.Value;
        var v1 = arguments[0].Evaluate(context);
