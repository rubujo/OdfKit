...
/// <summary>
/// Builds <see cref="FormulaDocument"/> content with a fluent API.
/// 提供 <see cref="FormulaDocument"/> 的 Fluent 建立 API。
/// </summary>
public sealed class FormulaDocumentBuilder
{
    private readonly FormulaDocument _document;

    internal FormulaDocumentBuilder(FormulaDocument document)
    {
