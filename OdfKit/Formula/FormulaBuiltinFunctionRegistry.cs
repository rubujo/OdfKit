...
internal static class FormulaBuiltinFunctionRegistry
{
    ...
    private static Dictionary<string, FormulaBuiltinHandler> CreateBuiltinRegistry()
    {
        return new Dictionary<string, FormulaBuiltinHandler>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["ACCRINT"] = CreateConformanceHandler("ACCRINT"),
            ["ACCRINTM"] = CreateConformanceHandler("ACCRINTM"),
            ["AMORLINC"] = CreateConformanceHandler("AMORLINC"),
            ["BESSELI"] = CreateConformanceHandler("BESSELI"),
            ["BESSELJ"] = CreateConformanceHandler("BESSELJ"),
            ["BESSELK"] = CreateConformanceHandler("BESSELK"),
            ["BESSELY"] = CreateConformanceHandler("BESSELY"),
            ["BETADIST"] = CreateConformanceHandler("BETADIST"),
            ["BETAINV"] = CreateConformanceHandler("BETAINV"),
            ["CHISQDIST"] = CreateConformanceHandler("CHISQDIST"),
            ["CHISQINV"] = CreateConformanceHandler("CHISQINV"),
            ["COUPDAYBS"] = CreateConformanceHandler("COUPDAYBS"),
            ["COUPDAYS"] = CreateConformanceHandler("COUPDAYS"),
            ["COUPDAYSNC"] = CreateConformanceHandler("COUPDAYSNC"),
            ["COUPNCD"] = CreateConformanceHandler("COUPNCD"),
            ["COUPNUM"] = CreateConformanceHandler("COUPNUM"),
            ["COUPPCD"] = CreateConformanceHandler("COUPPCD"),
            ["CRITBINOM"] = CreateConformanceHandler("CRITBINOM"),
            ["CUMIPMT"] = CreateConformanceHandler("CUMIPMT"),
            ["CUMPRINC"] = CreateConformanceHandler("CUMPRINC"),
            ["DAYS360"] = CreateConformanceHandler("DAYS360"),
            ["DB"] = CreateConformanceHandler("DB"),
            ["DDE"] = CreateConformanceHandler("DDE"),
            ["DISC"] = CreateConformanceHandler("DISC"),
            ["DOLLARDE"] = CreateConformanceHandler("DOLLARDE"),
            ["DOLLARFR"] = CreateConformanceHandler("DOLLARFR"),
            ["DURATION"] = CreateConformanceHandler("DURATION"),
            ["EFFECT"] = CreateConformanceHandler("EFFECT"),
            ["EUROCONVERT"] = CreateConformanceHandler("EUROCONVERT"),
            ["FDIST"] = CreateConformanceHandler("FDIST"),
            ["FINV"] = CreateConformanceHandler("FINV"),
            ["FORMULA"] = CreateConformanceHandler("FORMULA"),
            ["FREQUENCY"] = CreateConformanceHandler("FREQUENCY"),
            ["FTEST"] = CreateConformanceHandler("FTEST"),
            ["GAMMADIST"] = CreateConformanceHandler("GAMMADIST"),
            ["GAMMAINV"] = CreateConformanceHandler("GAMMAINV"),
            ["GETPIVOTDATA"] = CreateConformanceHandler("GETPIVOTDATA"),
            ["GROWTH"] = CreateConformanceHandler("GROWTH"),
            ["HYPERLINK"] = CreateConformanceHandler("HYPERLINK"),
            ["HYPGEOMDIST"] = CreateConformanceHandler("HYPGEOMDIST"),
            ["INFO"] = CreateConformanceHandler("INFO"),
            ["INTRATE"] = CreateConformanceHandler("INTRATE"),
            ["KURT"] = CreateConformanceHandler("KURT"),
            ["LEGACY.CHIDIST"] = CreateConformanceHandler("LEGACY.CHIDIST"),
            ["LEGACY.CHIINV"] = CreateConformanceHandler("LEGACY.CHIINV"),
            ["LEGACY.CHITEST"] = CreateConformanceHandler("LEGACY.CHITEST"),
            ["LEGACY.FDIST"] = CreateConformanceHandler("LEGACY.FDIST"),
            ["LEGACY.FINV"] = CreateConformanceHandler("LEGACY.FINV"),
            ["LEGACY.TDIST"] = CreateConformanceHandler("LEGACY.TDIST"),
            ["LINEST"] = CreateConformanceHandler("LINEST"),
            ["LOGEST"] = CreateConformanceHandler("LOGEST"),
            ["LOGINV"] = CreateConformanceHandler("LOGINV"),
            ["LOGNORMDIST"] = CreateConformanceHandler("LOGNORMDIST"),
            ["LOOKUP"] = CreateConformanceHandler("LOOKUP"),
            ["MDURATION"] = CreateConformanceHandler("MDURATION"),
            ["MULTIPLE.OPERATIONS"] = CreateConformanceHandler("MULTIPLE.OPERATIONS"),
            ["NOMINAL"] = CreateConformanceHandler("NOMINAL"),
            ["ODDFPRICE"] = CreateConformanceHandler("ODDFPRICE"),
            ["ODDFYIELD"] = CreateConformanceHandler("ODDFYIELD"),
            ["ODDLPRICE"] = CreateConformanceHandler("ODDLPRICE"),
            ["ODDLYIELD"] = CreateConformanceHandler("ODDLYIELD"),
            ["PERCENTRANK"] = CreateConformanceHandler("PERCENTRANK"),
            ["PRICE"] = CreateConformanceHandler("PRICE"),
            ["PRICEDISC"] = CreateConformanceHandler("PRICEDISC"),
            ["PRICEMAT"] = CreateConformanceHandler("PRICEMAT"),
            ["PROB"] = CreateConformanceHandler("PROB"),
            ["RECEIVED"] = CreateConformanceHandler("RECEIVED"),
            ["SHEET"] = CreateConformanceHandler("SHEET"),
            ["SHEETS"] = CreateConformanceHandler("SHEETS"),
            ["SKEW"] = CreateConformanceHandler("SKEW"),
            ["SKEWP"] = CreateConformanceHandler("SKEWP"),
            ["STEYX"] = CreateConformanceHandler("STEYX"),
            ["SUBTOTAL"] = CreateConformanceHandler("SUBTOTAL"),
            ["TBILLEQ"] = CreateConformanceHandler("TBILLEQ"),
            ["TBILLPRICE"] = CreateConformanceHandler("TBILLPRICE"),
            ["TBILLYIELD"] = CreateConformanceHandler("TBILLYIELD"),
            ["TINV"] = CreateConformanceHandler("TINV"),
            ["TREND"] = CreateConformanceHandler("TREND"),
            ["TRIMMEAN"] = CreateConformanceHandler("TRIMMEAN"),
            ["TTEST"] = CreateConformanceHandler("TTEST"),
            ["VDB"] = CreateConformanceHandler("VDB"),
            ["XIRR"] = CreateConformanceHandler("XIRR"),
            ["XNPV"] = CreateConformanceHandler("XNPV"),
            ["YEARFRAC"] = CreateConformanceHandler("YEARFRAC"),
            ["YIELD"] = CreateConformanceHandler("YIELD"),
            ["YIELDDISC"] = CreateConformanceHandler("YIELDDISC"),
            ["YIELDMAT"] = CreateConformanceHandler("YIELDMAT"),
            ["ZTEST"] = CreateConformanceHandler("ZTEST"),
        };
    }

    private static FormulaBuiltinHandler CreateConformanceHandler(string name)
        => (arguments, context) =>
            FormulaConformanceFunctionHandlers.Evaluate(name, arguments, context);
}
