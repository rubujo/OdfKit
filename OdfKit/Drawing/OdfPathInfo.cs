...
/// <summary>
/// Represents summary information for a path shape on a drawing page.
/// 表示繪圖頁面上一個路徑圖形的摘要資訊。
/// </summary>
    ...
    string? height)
{
    ...
    /// <summary>
    /// Gets the SVG path data description string.
    /// 取得 SVG path data 路徑描述字串。
    /// </summary>
    public string SvgPathData { get; } = svgPathData ?? string.Empty;
