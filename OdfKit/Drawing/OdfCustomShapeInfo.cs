...
/// <summary>
/// Represents summary information for a custom shape on a drawing page.
...
/// <param name="geometryType">The enhanced geometry type name (<c>draw:enhanced-geometry/@draw:type</c>). / 增強幾何類型名稱（<c>draw:enhanced-geometry/@draw:type</c>）。</param>
    ...
    string? height)
{
    ...
    /// <summary>
    /// Gets the enhanced geometry type name.
    /// 取得增強幾何類型名稱。
    /// </summary>
