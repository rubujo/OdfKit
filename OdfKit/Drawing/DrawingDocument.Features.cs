...
{
    /// <summary>
    /// Gets a summary list of path shapes from all drawing pages in the document.
    ...
    /// <summary>
    /// Gets a summary list of connectors from all drawing pages in the document.
    /// 取得文件中所有繪圖頁面的連接線摘要清單。
    /// </summary>
    ...
    /// <summary>
    /// Gets a summary list of polygon shapes from all drawing pages in the document.
    ...
    /// <summary>
    /// Gets a summary list of custom shapes from all drawing pages in the document.
    ...
    /// <summary>
    /// Gets a summary list of group shapes from all drawing pages in the document.
    ...
    /// <summary>
    /// Gets a summary list of layers from all drawing pages in the document.
    /// 取得文件中所有繪圖頁面的圖層摘要清單。
    /// </summary>
    ...
    /// <summary>
    /// Gets a summary list of text boxes from all drawing pages in the document.
    ...
    /// <summary>
    /// Gets a summary list of pictures from all drawing pages in the document.
    /// 取得文件中所有繪圖頁面的圖片摘要清單。
    /// </summary>
    ...
    /// <summary>
    /// Gets a summary list of shape-to-layer assignments from all drawing pages in the document.
