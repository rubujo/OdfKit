...
/// <summary>
/// Provides the OdfEncryptionInfo API.
/// 包含 ODF 封裝專案的加密與解密詳細資訊。
/// </summary>
public sealed class OdfEncryptionInfo
{
    /// <summary>
    /// Gets the ChecksumType value.
    ...
    /// <summary>
    /// Gets the AlgorithmName value.
    /// 取得或設定加密演算法名稱（識別 URI ）。
    /// </summary>
    public string AlgorithmName { get; set; } = string.Empty;

    /// <summary>
    /// Gets the InitialisationVector value.
    /// 取得或設定初始向量。
    /// </summary>
    public byte[] InitialisationVector { get; set; } = [];

    /// <summary>
    /// Gets the KeyDerivationName value.
    /// 取得或設定金鑰衍生函式名稱，預設為 PBKDF2 。
    /// </summary>
    public string KeyDerivationName { get; set; } = "PBKDF2";

    /// <summary>
    /// Gets the KeySize value.
    /// 取得或設定金鑰大小。
    /// </summary>
    public int KeySize { get; set; }

    /// <summary>
    /// Gets the IterationCount value.
    /// 取得或設定金鑰衍生的反覆運算次數。
    /// </summary>
...
/// <summary>
/// Provides the OdfOpenPgpRecipient API.
/// 表示 OpenPGP 加密收件者。
/// </summary>
public sealed class OdfOpenPgpRecipient
{
    /// <summary>
    /// Gets the KeyId value.
    /// 取得或設定 OpenPGP 金鑰識別碼。
    /// </summary>
...
/// <summary>
/// Provides the OdfOpenPgpEncryptedKeyInfo API.
