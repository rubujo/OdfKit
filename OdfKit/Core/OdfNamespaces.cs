...
/// <summary>
/// Provides the OdfNamespaces API.
...
public static class OdfNamespaces
{
    ...
    /// <summary>
    /// OpenFormula 命名空間 URI（ODF 1.2+ 公式語言，<c>table:formula</c> 等屬性值內 <c>of:=</c> 前綴所指涉的命名空間）
    /// </summary>
    public const string Of = "urn:oasis:names:tc:opendocument:xmlns:of:1.2";

    /// <summary>
    /// OpenOffice.org Calc 相容命名空間 URI（<c>table:condition</c> 內容驗證條件值內 <c>oooc:</c> 前綴所指涉的命名空間）
    /// </summary>
    public const string Oooc = "http://openoffice.org/2004/calc";

    /// <summary>
    /// MathML 命名空間 URI（<c>office:formula</c> 內嵌公式內容所使用的數學標記語言命名空間）
    /// </summary>
    public const string MathMl = "http://www.w3.org/1998/Math/MathML";

    /// <summary>
    /// Dr3d 命名空間 URI（3D 繪圖物件，如 <c>dr3d:light</c>、<c>dr3d:scene</c>）
    /// </summary>
