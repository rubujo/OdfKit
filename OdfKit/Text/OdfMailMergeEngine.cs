...
/// <summary>
/// Represents the mail merge engine for ODF documents.
/// 表示 ODF 文件的郵件合併引擎。
/// </summary>
/// <param name="doc">The target text document. / 目標文字文件。</param>
public partial class OdfMailMergeEngine(TextDocument doc)
{
    ...
    /// <summary>
    /// Executes the mail merge operation.
    /// 執行郵件合併作業。
    /// </summary>
    /// <param name="root">The root node of the mail merge. / 郵件合併的根節點。</param>
    /// <param name="dataSource">The data source object used for the merge. / 用來合併的資料來源物件。</param>
    ...
    /// <summary>
    /// Executes the mail merge operation and returns a report, with optional configuration.
    /// 執行郵件合併作業並傳回報告，支援 options 設定。
    /// </summary>
    /// <param name="root">The root node of the mail merge. / 郵件合併的根節點。</param>
    /// <param name="dataSource">The data source object used for the merge. / 用來合併的資料來源物件。</param>
    /// <param name="options">The mail merge options; default values are used if <see langword="null"/>. / 郵件合併選項，若為 null 則使用預設值。</param>
