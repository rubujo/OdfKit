...
/// <summary>
/// Provides odf sub document reference.
/// 描述主控文字文件中指向外部子文件的區段參照。
/// </summary>
/// <param name="SectionName">The name or identifier. / 區段名稱（<c>text:section/@text:name</c>）</param>
/// <param name="Href">The path or URI. / 子文件 URI（<c>text:section-source/@xlink:href</c>）</param>
/// <param name="Actuate">
