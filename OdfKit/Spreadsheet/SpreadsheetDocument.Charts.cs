...
public partial class SpreadsheetDocument
{
    ...
    /// </summary>
    /// <param name="chartInfo">The value to use. / 嵌入圖表摘要資訊</param>
    /// <returns>The result. / 可編輯的 <see cref="OdfChartDocument"/> 執行個體</returns>
    /// <remarks>
    ...
    /// 依子封裝路徑取得嵌入圖表文件。
    /// </summary>
    /// <param name="objectPath">The name or identifier. / 嵌入圖表子封裝路徑（例如 <c>Object 1/</c>）</param>
    /// <returns>The result. / 可編輯的 <see cref="OdfChartDocument"/> 執行個體</returns>
    /// <remarks>
