...
public partial class OdfCell
{
    ...
    /// <summary>
    /// Short overload of AddConditionalFormatMap that accepts condition and applyStyleName; remaining optional parameters use defaults and forward to the full overload.
    /// 便利多載：提供 condition 與 applyStyleName；其餘可選參數使用預設值並轉呼叫最長 AddConditionalFormatMap 多載。
    /// </summary>
