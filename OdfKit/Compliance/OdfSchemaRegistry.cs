...
{
    /// <summary>
    /// Provides versioned ODF schema metadata used by validators and typed DOM layers.
    /// </summary>
    public static class OdfSchemaRegistry
    {
        private static readonly object SyncRoot = new object();
        private static readonly OdfVersionRange AllKnown = OdfVersionRange.AllKnown;
        private static readonly Uri Odf14SchemaSource = new Uri("https://docs.oasis-open.org/office/OpenDocument/v1.4/os/schemas/OpenDocument-v1.4-schema.rng");
        ...
        private static readonly Dictionary<OdfVersion, OdfSchemaSet> RegisteredSchemas = new Dictionary<OdfVersion, OdfSchemaSet>();

        /// <summary>
        /// Gets the latest ODF schema metadata available in this library.
        /// </summary>
        public static OdfSchemaSet Latest => GetSchema(OdfVersion.Odf14);

        /// <summary>
        /// Gets the ODF 1.4 schema metadata seed.
        /// </summary>
        ...
        /// <summary>
        /// Gets schema metadata for the requested version.
        /// </summary>
        ...
        /// <summary>
        /// Registers generated schema metadata for a version until the returned scope is disposed.
        /// </summary>
        ...
        private sealed class RegistrationScope : IDisposable
        {
            ...
            private readonly OdfSchemaSet? _previous;
            private bool _disposed;

            public RegistrationScope(OdfVersion version, OdfSchemaSet? previous)
            {
                _version = version;
                _previous = previous;
            }
