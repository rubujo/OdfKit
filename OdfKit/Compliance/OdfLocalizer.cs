...
public static partial class OdfLocalizer
{
    ...
    /// <summary>
    /// Short overload of GetSuggestedFix that accepts ruleId; remaining optional parameters use defaults and forward to the full overload.
    /// 便利多載：提供 ruleId；其餘可選參數使用預設值並轉呼叫最長 GetSuggestedFix 多載。
    /// </summary>
