...
public partial class OdfDatabaseDocument
{
    ...
    /// <summary>
    /// Merges the content nodes of a source database document into this document.
    /// 合併來源資料庫文件的內容節點至此文件。
    /// </summary>
    ...
    /// <exception cref="ArgumentException">When the source document is not an <see cref="OdfDatabaseDocument"/>. / 當來源文件不是 <see cref="OdfDatabaseDocument"/> 時擲出。</exception>
