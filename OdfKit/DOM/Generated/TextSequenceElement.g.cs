...
namespace OdfKit.DOM
{
    ...
    {
        public TextSequenceElement() : this((string?)null) { }

        public TextSequenceElement(string? prefix) : base("sequence", "urn:oasis:names:tc:opendocument:xmlns:text:1.0", prefix) { }
