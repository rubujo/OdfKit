...
namespace OdfKit.DOM
{
    ...
    {
        public TableLabelRangeElement() : this((string?)null) { }

        public TableLabelRangeElement(string? prefix) : base("label-range", "urn:oasis:names:tc:opendocument:xmlns:table:1.0", prefix) { }
