...
namespace OdfKit.DOM
{
    ...
    public partial class TextDatabaseRowNumberElement : OdfElement
    {
        ...
        public int? Value
        {
            get => GetNullableInt32AttributeValue("value", "urn:oasis:names:tc:opendocument:xmlns:text:1.0", GetDocumentVersion());
            set
            {
                if (value == null)
                    RemoveAttribute("value", "urn:oasis:names:tc:opendocument:xmlns:text:1.0");
                else
                    SetInt32AttributeValue("value", "urn:oasis:names:tc:opendocument:xmlns:text:1.0", value.Value, "text", GetDocumentVersion());
            }
        }
