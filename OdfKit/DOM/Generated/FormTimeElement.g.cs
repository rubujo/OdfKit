...
namespace OdfKit.DOM
{
    ...
    public partial class FormTimeElement : OdfElement
    {
        ...
        public OdfTime? CurrentValue
        {
            get => GetTimeAttributeValue("current-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", GetDocumentVersion());
            set
            {
                if (value == null)
                    RemoveAttribute("current-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0");
                else
                    SetTimeAttributeValue("current-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", value.Value, "ns", GetDocumentVersion());
            }
        }
        ...
        public OdfTime? FormValue
        {
            get => GetTimeAttributeValue("value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", GetDocumentVersion());
            set
            {
                if (value == null)
                    RemoveAttribute("value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0");
                else
                    SetTimeAttributeValue("value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", value.Value, "ns", GetDocumentVersion());
            }
        }
        ...
        public OdfTime? MaxValue
        {
            get => GetTimeAttributeValue("max-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", GetDocumentVersion());
            set
            {
                if (value == null)
                    RemoveAttribute("max-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0");
                else
                    SetTimeAttributeValue("max-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", value.Value, "ns", GetDocumentVersion());
            }
        }

        public OdfTime? MinValue
        {
            get => GetTimeAttributeValue("min-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", GetDocumentVersion());
            set
            {
                if (value == null)
                    RemoveAttribute("min-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0");
                else
                    SetTimeAttributeValue("min-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", value.Value, "ns", GetDocumentVersion());
            }
        }
