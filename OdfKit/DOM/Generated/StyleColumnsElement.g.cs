...
namespace OdfKit.DOM
{
    ...
    {
        public StyleColumnsElement() : this((string?)null) { }

        public StyleColumnsElement(string? prefix) : base("columns", "urn:oasis:names:tc:opendocument:xmlns:style:1.0", prefix) { }
