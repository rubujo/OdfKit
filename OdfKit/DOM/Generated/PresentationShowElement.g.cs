...
namespace OdfKit.DOM
{
    ...
    {
        public PresentationShowElement() : this((string?)null) { }

        public PresentationShowElement(string? prefix) : base("show", "urn:oasis:names:tc:opendocument:xmlns:presentation:1.0", prefix) { }
