...
namespace OdfKit.DOM
{
    ...
    {
        public PresentationPlayElement() : this((string?)null) { }

        public PresentationPlayElement(string? prefix) : base("play", "urn:oasis:names:tc:opendocument:xmlns:presentation:1.0", prefix) { }
