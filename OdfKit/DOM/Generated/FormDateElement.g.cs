...
namespace OdfKit.DOM
{
    ...
    public partial class FormDateElement : OdfElement
    {
        ...
        {
            get => GetDateTimeAttributeValue("current-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", GetDocumentVersion());
            set
            {
                if (value == null)
                    RemoveAttribute("current-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0");
                else
                    SetDateTimeAttributeValue("current-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", value.Value, "ns", GetDocumentVersion());
            }
        }
        ...
        public DateTime? FormValue
        {
            get => GetDateTimeAttributeValue("value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", GetDocumentVersion());
            set
            {
                if (value == null)
                    RemoveAttribute("value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0");
                else
                    SetDateTimeAttributeValue("value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", value.Value, "ns", GetDocumentVersion());
            }
        }
        ...
        {
            get => GetDateTimeAttributeValue("max-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", GetDocumentVersion());
            set
            {
                if (value == null)
                    RemoveAttribute("max-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0");
                else
                    SetDateTimeAttributeValue("max-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", value.Value, "ns", GetDocumentVersion());
            }
        }

        public DateTime? MinValue
        {
            get => GetDateTimeAttributeValue("min-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", GetDocumentVersion());
            set
            {
                if (value == null)
                    RemoveAttribute("min-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0");
                else
                    SetDateTimeAttributeValue("min-value", "urn:oasis:names:tc:opendocument:xmlns:form:1.0", value.Value, "ns", GetDocumentVersion());
            }
        }
