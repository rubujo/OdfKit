...
namespace OdfKit.DOM
{
    ...
    {
        public TableDataPilotMemberElement() : this((string?)null) { }

        public TableDataPilotMemberElement(string? prefix) : base("data-pilot-member", "urn:oasis:names:tc:opendocument:xmlns:table:1.0", prefix) { }
