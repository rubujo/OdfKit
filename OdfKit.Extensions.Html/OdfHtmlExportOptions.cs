...
{
    /// <summary>
    /// Gets or sets whether the exporter emits a complete HTML document.
    ...
    /// <summary>
    /// Gets or sets the generated HTML page title.
    /// 取得或設定頁面標題，用於 title 標籤，預設為空字串。
    /// </summary>
    public string Title { get; init; } = string.Empty;

    /// <summary>
    /// Gets or sets whether the exporter emits inline CSS styles.
    /// 取得或設定是否內嵌基本 CSS 樣式表，預設為 true。
    /// </summary>
    public bool InlineStyles { get; init; } = true;

    /// <summary>
    /// Gets or sets the character set declaration for generated HTML.
