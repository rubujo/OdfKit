...
$sourcePath = Join-Path $domDir 'OdfElement.AttributeAccessors.cs'
...
function Get-UsingsForBlock {
    ...
    if ($Text -match 'OdfPackage|OdfNode|OdfNamespaces|OdfIriReference') { [void]$needed.Add('OdfKit.Core') }
    if ($Text -match 'OdfLength|OdfStyle|OdfDraw|OdfFo|OdfPresentation|OdfSmil|OdfXLink|OdfNumber|OdfTable') { [void]$needed.Add('OdfKit.Styles') }
