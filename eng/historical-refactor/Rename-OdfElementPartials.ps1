...
$renames = @(
    @{ Old = 'OdfElement.AttributeValues.A1.cs'; New = 'OdfElement.AttributeValues.StyleAndPresentation.cs'; Region = 'Attribute Values - Style & Presentation' }
    @{ Old = 'OdfElement.AttributeValues.A2.cs'; New = 'OdfElement.AttributeValues.ScriptTableAndAnimation.cs'; Region = 'Attribute Values - Script, Table & Animation' }
    @{ Old = 'OdfElement.AttributeValues.B1a1.cs'; New = 'OdfElement.AttributeValues.DrawFoAndStroke.cs'; Region = 'Attribute Values - Draw, FO & Stroke' }
    @{ Old = 'OdfElement.AttributeValues.B1a2.cs'; New = 'OdfElement.AttributeValues.TextListAndReference.cs'; Region = 'Attribute Values - Text List & Reference' }
    @{ Old = 'OdfElement.AttributeValues.B1b.cs'; New = 'OdfElement.AttributeValues.TextCaptionAndAddress.cs'; Region = 'Attribute Values - Text Caption & Address' }
    @{ Old = 'OdfElement.AttributeValues.B2.cs'; New = 'OdfElement.AttributeValues.GeometryLocaleAndLine.cs'; Region = 'Attribute Values - Geometry, Locale & Line' }
